...
voltage_jump_scale = 1.33    #multiplies how far the numerical diff. function jumps during autocalibration
INITIAL_START_UP_VOLTAGE = [58.0,61.0] #used to verify output stability
INITIAL_START_UP_CURRENT = [0.035,0.0305] #used to verify input stability
OUTPUT_VOLTAGE_COLD = [48.0,51.0]
INPUT_CURRENT_COLD = [0.0225,0.027] #same here
...
q_time_interval_scale = 0.20     #timer multiple of 100, ie 0.2*100 = 20
